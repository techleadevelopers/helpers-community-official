...
function Home() {
  ...
  useEffect(() => { document.title = 'Helpers — quando um animal precisa, uma rede inteira se move'; }, []);
  const roles = [
  ...
  <img
    ...
    style={{
      ...
      zIndex: 3,
      pointerEvents: 'none',
      filter: 'drop-shadow(0 4px 8px rgba(63,100,76,0.22))',
    }}
  />
  ...
  <span className="grid size-8 place-items-center rounded-full border-2 border-[#f8faf7] bg-[#f2d0cb] overflow-hidden">
    <img src="https://res.cloudinary.com/limpeja/image/upload/v1789338320/WhatsApp_Image_2026-09-13_at_19.23.41_ayottp.jpg" alt="Avatar" className="h-full w-full object-cover" />
  </span>
  <span className="grid size-8 place-items-center rounded-full border-2 border-[#f8faf7] bg-[#e9d9c7] overflow-hidden">
